        ...
        <section id="PlanExplanation">
            <div className="Container">
                    <div className="Container-header">
                        ...
                        <p>旅のしおりの作成と共有ができる〇〇です。無料かつアプリダウンロードも不要！ブラウザがあれば旅行プランが作成可能です。「女子旅」「卒業旅行」「社員旅行」「家族旅行」「一人旅」「修学旅行」の計画を立ててみませんか？</p>
                    </div>
                    <br />
                ...
                <button><Link to="/Page1" style={{textDecoration: 'none' ,color: 'black', padding: '20px'}}>新規登録・ログインする</Link></button>
                <br />
